...
<div id="boardSpace">
	<div id="fix">
		<div id="btn">
			<ul>
				<li class="freeBoard_select active"><p>자유게시판</p></li>
				<li class="teamBoard_select"
					onclick="location.href='${pageContext.request.contextPath}/board/teamBoard'"><p>일행구하기</p></li>
		...
		<c:if test="${loginMember.memberNick !=null}">
			<div id="writeBtn">
				<a class="btn btn-default pull-right"
					onclick="location.href='${pageContext.request.contextPath}/board/freeBoard_write'">글쓰기</a>
			</div>
		</c:if>
...
<script type="text/javascript">
	...
	function boardListDisplay(pageNum) {
		...
		$
				.ajax({
					type : "get",
					url : "${pageContext.request.contextPath}/board/freeBoard_list?pageNum="
							+ pageNum,
					dataType : "json",
					success : function(json) {
						if (json.freeBoardList.length == 0) {
